...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenidoPaginas" runat="server">
    ...
    <div>
        <asp:Panel runat="server" ID="PanelColapsableVeh" Visible="false">
            <div class="collapseBar">
                <span><strong style="text-transform: uppercase">
    ...
    <asp:Panel ID="PanelABMReparaciones" runat="server" Enabled="false">
        <table class="basetable">
            <tr>
                <td>
                    <strong>
            ...
            <tr>
                <td>
                    ...
                    <div class="fifty">
                        <asp:Label ID="LabelRepaIdItem" runat="server" Text="IdItem" Enable=false Visible="False"></asp:Label><br />
    ...
    <div>
        <asp:GridView ID="GridViewReparaciones" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false" OnSelectedIndexChanged="GridViewReparaciones_SelectedIndexChanged" >
            ...
            <Columns>
                ...
                <asp:BoundField DataField="precio_cotizado" HeaderText="Precio Cotizado" DataFormatString="{0:C2}"/>
                ...
                <asp:BoundField DataField="precio_final" HeaderText="Precio Final" DataFormatString="{0:C2}"/>
                <asp:BoundField DataField="proveedor" HeaderText="Proveedor" />
                <asp:ButtonField Text="Editar" CommandName="Edit" ItemStyle-Width="50" ItemStyle-ForeColor="Blue" />
            </Columns>
        </asp:GridView>
    </div>
    <div>
