...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenidoPaginas" runat="server">
    <div>
                ...
                <table class="basetable">
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="thirty">
                                <asp:Label ID="LabelPerIdItem" runat="server" Text="Id Pericular:" Visible="false"></asp:Label><br />
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="ButtonPerAgregar" runat="server" Text="Actualizar" visible="true" OnClick="ButtonPerAgregar_Click" />
        ...
        <div>
            <asp:GridView ID="GridViewPerDetalle" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false">
