<%@ Page Title="" Language="C#" MasterPageFile="~/SitioICRL.Master" AutoEventWireup="true" CodeBehind="CotizacionDP.aspx.cs" Inherits="ICRL.Presentacion.CotizacionDP"  MaintainScrollPositionOnPostback="true" %>
    ...
    <div>
        ...
        <div>
            <table class="basetable alt2">
                ...
                <tr><td><asp:Button ID="ButtonRepaAgregarItem" runat="server" Text="Agregar" OnClick="ButtonRepaAgregarItem_Click" CssClass="alt2" /></td></tr>
                <tr><td>
        ...
        <div>
          <table class="basetable alt3">
            ...
            <tr><td>
              <asp:GridView ID="GridViewOrdenes" runat="server" CellPadding="4" GridLines="None" AutoGenerateColumns="false" Width="100%" 
                DataKeyNames="numero_orden" OnRowCommand="GridViewOrdenes_RowCommand">
                  <Columns>
            ...
            <asp:Panel ID="PanelModalPopupABMReparaciones" runat="server" CssClass="modalPopup">
                ...
                <div>
                    <table class="basetable alt2">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="ButtonRepaGrabar" runat="server" Text="Grabar" Enabled="False" OnClick="ButtonRepaGrabar_Click" CssClass="alt2" />
                                <asp:Button ID="ButtonRepaCancelar" runat="server" Text="Cancelar" Enabled="False" OnClick="ButtonRepaCancelar_Click" CssClass="alt2" />
                            </td>
                        </tr>
                    </table>
                </div>
                <asp:Button ID="ButtonCancelPopReparaciones" runat="server" Text="Cerrar" OnClick="ButtonCancelPopReparaciones_Click" CssClass="alt2" />
            </asp:Panel>
        </div>
            ...
            <asp:Panel ID="PanelModalPopupABMRepuestos" runat="server" CssClass="modalPopup">
                ...
                <div>
                    <table class="basetable alt2">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="ButtonRepuGrabar" runat="server" Text="Grabar" Enabled="False" OnClick="ButtonRepuGrabar_Click" CssClass="alt2" />
                                <asp:Button ID="ButtonRepuCancelar" runat="server" Text="Cancelar" Enabled="False" OnClick="ButtonRepuCancelar_Click" CssClass="alt2" />
                            </td>
                        </tr>
                    </table>
                </div>
                <asp:Button ID="ButtonCancelPopRepuestos" runat="server" Text="Cerrar" OnClick="ButtonCancelPopRepuestos_Click" CssClass="alt2" />
            </asp:Panel>
        </div>
            ...
            <asp:Panel ID="PanelModalPopupABMSumatorias" runat="server" CssClass="modalPopup">
                ...
                <div>
                    <table class="basetable alt2">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="ButtonSumaGrabar" runat="server" Text="Grabar" Enabled="False" OnClick="ButtonSumaGrabar_Click" CssClass="alt2" />
                                <asp:Button ID="ButtonSumaCancelar" runat="server" Text="Cancelar" Enabled="False" OnClick="ButtonSumaCancelar_Click" CssClass="alt2" />
                            </td>
                        </tr>
                    </table>
                </div>
                <asp:Button ID="ButtonCancelPopSumatorias" runat="server" Text="Cerrar" OnClick="ButtonCancelPopSumatorias_Click" CssClass="alt2" />
            </asp:Panel>
        </div>
            ...
            <asp:Panel ID="PanelModalPopupRecepRepuestos" runat="server" CssClass="modalPopup">
                ...
                <div>
                    <table class="basetable alt2">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="ButtonRecepGrabar" runat="server" Text="Grabar" Enabled="False" OnClick="ButtonRecepGrabar_Click" CssClass="alt2" />
                                <asp:Button ID="ButtonRecepCancelar" runat="server" Text="Cancelar" Enabled="False" OnClick="ButtonRecepCancelar_Click" CssClass="alt2" />
                            </td>
                        </tr>
                    </table>
                </div>
                <asp:Button ID="ButtonCancelPopRecepRepuestos" runat="server" Text="Cerrar" OnClick="ButtonCancelPopRecepRepuestos_Click" CssClass="alt2" />
            </asp:Panel>
        </div>
        <div>
