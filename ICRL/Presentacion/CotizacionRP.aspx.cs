  ...
  public partial class CotizacionRP : System.Web.UI.Page
  {
    ...
    protected void ButtonRepaGrabar_Click(object sender, EventArgs e)
    {
      ...
      if ("A" == TextBoxRepaFlagEd.Text)
      {
        ...
        if (("OTRO (S)" == vTipoRoboParcial.item_descripcion) && (!string.IsNullOrWhiteSpace(TextBoxRepaItem.Text)))
        {
          vTipoRoboParcial.item_descripcion = TextBoxRepaItem.Text.ToUpper();
        }
      }
      else
      {
    ...
    protected void ButtonRepuGrabar_Click(object sender, EventArgs e)
    {
      ...
      if ("A" == TextBoxRepuFlagEd.Text)
      {
        ...
        if (("OTRO (S)" == vTipoRoboParcial.item_descripcion) && (!string.IsNullOrWhiteSpace(TextBoxRepuItem.Text)))
        {
          vTipoRoboParcial.item_descripcion = TextBoxRepuItem.Text.ToUpper();
        }
      }
      else
      {
    ...
    private int FlTraeDatosSumatoriaReparaciones(int pIdFlujo, int pIdCotizacion, short pTipoItem)
    {
      ...
      GridViewSumaReparaciones.DataSource = vTipoRoboParcialSumatoriaTraer.RoboParcialSumatoria.Select(RoboParcialSumatoria => new
      {
        ...
        RoboParcialSumatoria.moneda_orden
      }).ToList();
    ...
    protected void PImprimeFormularioCotiRoboParcial(string pNroOrden)
    {
      ...
      var vListaCotizacionUsuario = from cc in db.cotizacion_robo_parcial
      ...
      {
        ReportViewerCoti.LocalReport.ReportPath = "Reportes\\RepFormularioCotiOrdenTrabajo.rdlc";
      }
      else
      {
        if ("OC" == pNroOrden.Substring(0, 2))
        {
          ReportViewerCoti.LocalReport.ReportPath = "Reportes\\RepFormularioCotiOrdenCompra.rdlc";
        }
        else
        {
          ReportViewerCoti.LocalReport.ReportPath = "Reportes\\RepFormularioCotiOrdenPagoCambio.rdlc";
        }
      }
      ...
      if (string.Empty != TextBoxBeneficiario.Text)
      {
        ...
        if (vIndiceDataTable >= 0)
        {
          ...
          if (vIndiceDataTable >= 0)
          {
            ...
            BD.CotizacionICRL.RoboParcialSumatoriaModificarTodos(vDatasetOrdenes, vNombreBeneficiario);
          }
          if (1 == vTipoItem)
          {
            ButtonRepaCambioBenef.Visible = false;
    ...
    protected void ButtonTallerGenCambiar_Click(object sender, EventArgs e)
    {
      ...
      if (string.Empty != TextBoxTallerGen.Text)
      {
        ...
        if (vIndiceDataTable >= 0)
        {
          ...
          BD.CotizacionICRL.RoboParcialSumatoriaModificarTodos(vDatasetOrdenes, vNombreTallerGen);
